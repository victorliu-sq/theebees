...
# specify one process and set interval to 1s
args.pid = 3327
args.interval = 1
...
bucket_idx2runqlat_sum = defaultdict(int)
bucket_idx2runqlat_avg = defaultdict(float)
total_time = 0
...
while (1):
    ...
    with open(db_path, "w") as f:
        data["runqlat_avg"] = bucket_idx2runqlat_avg
